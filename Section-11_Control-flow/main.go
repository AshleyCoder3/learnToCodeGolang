...
func main() {
	...
	*/
	...
	case 40:
		fmt.Println("x is 40")
		fallthrough // If it hits here it goes to next case automatically without checking the case
	case 41:
	...
	*/
	...
	for {
		...
		if y > 20 {
			break // out of loop // exit loop // will print (above) til 21 then exit for loop
		}
		y++
	}
	...
	for i := 0; i < 20; i++ { // doesn't include 20
		if i%2 != 0 {
			continue // start loop over // step out"Stop" of loop and start it over // doesn't hit next line
		}
